...
module.exports = (baseURL) => {
    ...
    return {
         ...
         */
        name (name, fullText = false, extra = {}) {
            return api.get(`/name/${name}`, { params: Object.assign({}, fullText ? { fullText } : {}, fixExtra(extra)) }).then(_ => _.data)
        },
         ...
         */
        code (code, extra = {}) {
            return api.get(`/alpha/${code.toLowerCase()}`, { params: Object.assign({}, fixExtra(extra)) }).then(_ => _.data)
        },
        ...
        async codes (codes, extra = {}) {
            ...
            return api.get('/alpha', { params: Object.assign({}, { codes: actualCodes.toLowerCase() }, fixExtra(extra)) }).then(_ => _.data)
        },
        ...
        currency (currency, extra = {}) {
            return api.get(`/currency/${currency.toLowerCase()}`, { params: Object.assign({}, fixExtra(extra)) }).then(_ => _.data)
        },
        ...
        language (language, extra = {}) {
            return api.get(`/lang/${language.toLowerCase()}`, { params: Object.assign({}, fixExtra(extra)) }).then(_ => _.data)
        },
        ...
        capital (capital, extra = {}) {
            return api.get(`/capital/${capital.toLowerCase()}`, { params: Object.assign({}, fixExtra(extra)) }).then(_ => _.data)
        },
         ...
         */
        callingCode (callingCode, extra = {}) {
            return api.get(`/callingcode/${callingCode}`, { params: Object.assign({}, fixExtra(extra)) }).then(_ => _.data)
        },
         ...
         */
        region (region, extra = {}) {
            return api.get(`/region/${region.toLowerCase()}`, { params: Object.assign({}, fixExtra(extra)) }).then(_ => _.data)
        },
         ...
         */
        regionalBloc (regionalBloc, extra = {}) {
            return api.get(`/regionalbloc/${regionalBloc.toLowerCase()}`, { params: Object.assign({}, fixExtra(extra)) }).then(_ => _.data)
        }
    }
}